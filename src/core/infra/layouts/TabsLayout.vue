<template>
    <ion-tabs>
      ...
      <ion-tab-bar :translucent=true slot="bottom">
        <!-- <ion-tab-button tab="app" @onClick.stop="selectPage('/')"> -->
        <ion-tab-button tab="app" href="/">
...
import { ref } from 'vue';
import { apps, add, person, mic, checkmarkDone, list, close, trash } from 'ionicons/icons';
...
import { useApp } from '@/core/controller/appController';

const { selectPage } = useApp();
const isOpen = ref();
const items = ref([])
const input = ref();
