<template>
    <button @click='$emit("animation")' class='btn div_btn_add shadow' :class='{active:active_navbar, error_add: error_add_task}'>   
...
export default {
    props: {
        ...
        animation_add:Boolean,
        error_add_task:Boolean,
    } 
}
</script>
